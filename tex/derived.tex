...
\item $B\lor C\vdash(B\implies A\land B)\implies((C\implies A\land C)\implies(A\land B)\lor(A\land C))$
...
\begin{proof}
\begin{enumerate}
\item $A[z]\vdash A[z]$ by assuming
\item $A[z]\vdash\exists y\ldotp A[y]$ by $\exists$-introduction(1)
\item $\vdash A[z]\implies\exists y\ldotp A[y]$ by discharging(2)
\item $\vdash(\exists x\ldotp A[x])\implies(\exists y\ldotp A[y])$ by $\exists$-elimination(3)\qedhere
\end{enumerate}
\end{proof}
...
fun exists_cong x y A =
  ...
  then raise Fail "\nwlinkedidentc{Derived.exists_cong}{NW1NjfzY-uZfts-C}: first argument is not a variable"
  else if not(Term.is_var y)
  then raise Fail "\nwlinkedidentc{Derived.exists_cong}{NW1NjfzY-uZfts-C}: second argument is not a variable"
  else if not(Term.have_same_sort x y)
  then raise Fail "\nwlinkedidentc{Derived.exists_cong}{NW1NjfzY-uZfts-C}: variables of different sorts"
  else let
...
, Test.mk "exists_cong_test" (fn () =>
    let
      ...
      val actual = Thm.concl(\nwlinkedidentc{Derived.exists_cong}{NW1NjfzY-uZfts-C} x y A);
    in
      Assert.that (Formula.eq expected actual)
                  (concat ["Expecting: ",
                           (Formula.serialize expected),
...
fun exists_elim (v : Term.t) (th1 : Thm.t) (th2 : Thm.t) : Thm.t =
  let
    ...
    \LA{}Ensure \code{}v\edoc{} is ``free enough'' for \code{}Tactic.exists{\_}elim\edoc{}~{\nwtagstyle{}\subpageref{NW1NjfzY-1ErEEN-1}}\RA{};
...
\nwindexdefn{\nwixident{Derived.exists{\_}elim}}{Derived.exists:unelim}{NW1NjfzY-uZfts-D}\eatline
\nwused{\\{NW1NjfzY-4dPl0p-1}}\nwidentdefs{\\{{\nwixident{Derived.exists{\_}elim}}{Derived.exists:unelim}}}\nwidentuses{\\{{\nwixident{Formula.subst}}{Formula.subst}}\\{{\nwixident{Term.t}}{Term.t}}\\{{\nwixident{Thm.concl}}{Thm.concl}}\\{{\nwixident{Thm.disch}}{Thm.disch}}\\{{\nwixident{Thm.exists{\_}elim}}{Thm.exists:unelim}}\\{{\nwixident{Thm.modus{\_}ponens}}{Thm.modus:unponens}}\\{{\nwixident{Thm.t}}{Thm.t}}}\nwindexuse{\nwixident{Formula.subst}}{Formula.subst}{NW1NjfzY-uZfts-D}\nwindexuse{\nwixident{Term.t}}{Term.t}{NW1NjfzY-uZfts-D}\nwindexuse{\nwixident{Thm.concl}}{Thm.concl}{NW1NjfzY-uZfts-D}\nwindexuse{\nwixident{Thm.disch}}{Thm.disch}{NW1NjfzY-uZfts-D}\nwindexuse{\nwixident{Thm.exists{\_}elim}}{Thm.exists:unelim}{NW1NjfzY-uZfts-D}\nwindexuse{\nwixident{Thm.modus{\_}ponens}}{Thm.modus:unponens}{NW1NjfzY-uZfts-D}\nwindexuse{\nwixident{Thm.t}}{Thm.t}{NW1NjfzY-uZfts-D}\nwendcode{}\nwbegindocs{135}\nwdocspar
\begin{node}
We want to raise an error ``as soon as possible'' if the assumptions
of existential-elimination are violated (to inform the user in a
reasonable place). We also want to provide ``informative enough''
error messages.
\end{node}

\nwenddocs{}\nwbegincode{136}\sublabel{NW1NjfzY-1ErEEN-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW1NjfzY-1ErEEN-1}}}\moddef{Ensure \code{}v\edoc{} is ``free enough'' for \code{}Tactic.exists{\_}elim\edoc{}~{\nwtagstyle{}\subpageref{NW1NjfzY-1ErEEN-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW1NjfzY-uZfts-D}}\nwenddeflinemarkup
val _ = if List.exists (Term.eq v)
                       (Formula.fv (Thm.concl th1))
        then raise Thm.Fail "\nwlinkedidentc{Derived.exists_elim}{NW1NjfzY-uZfts-D}: v is free in th1"
        else ();
val _ = if List.exists (Term.eq v)
                       (Formula.fv (Thm.concl th2))
        then raise Thm.Fail "\nwlinkedidentc{Derived.exists_elim}{NW1NjfzY-uZfts-D}: v is free in conclusion of th2"
        else ();
val _ = if List.exists (Term.eq v)
                       (List.concat (map Formula.fv (Thm.hyps th2)))
        then raise Thm.Fail "\nwlinkedidentc{Derived.exists_elim}{NW1NjfzY-uZfts-D}: v is free in hypothesis of th2"
        else ();
\nwused{\\{NW1NjfzY-uZfts-D}}\nwidentuses{\\{{\nwixident{Derived.exists{\_}elim}}{Derived.exists:unelim}}\\{{\nwixident{Formula.fv}}{Formula.fv}}\\{{\nwixident{Term.eq}}{Term.eq}}\\{{\nwixident{Thm.concl}}{Thm.concl}}\\{{\nwixident{Thm.hyps}}{Thm.hyps}}}\nwindexuse{\nwixident{Derived.exists{\_}elim}}{Derived.exists:unelim}{NW1NjfzY-1ErEEN-1}\nwindexuse{\nwixident{Formula.fv}}{Formula.fv}{NW1NjfzY-1ErEEN-1}\nwindexuse{\nwixident{Term.eq}}{Term.eq}{NW1NjfzY-1ErEEN-1}\nwindexuse{\nwixident{Thm.concl}}{Thm.concl}{NW1NjfzY-1ErEEN-1}\nwindexuse{\nwixident{Thm.hyps}}{Thm.hyps}{NW1NjfzY-1ErEEN-1}\nwendcode{}\nwbegindocs{137}\nwdocspar

\nwenddocs{}\nwbegincode{138}\sublabel{NW1NjfzY-3rvgpx-C}\nwmargintag{{\nwtagstyle{}\subpageref{NW1NjfzY-3rvgpx-C}}}\moddef{Unit tests for \code{}Derived.sml\edoc{}~{\nwtagstyle{}\subpageref{NW1NjfzY-3rvgpx-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW1NjfzY-4W6DdR-1}}\nwprevnextdefs{NW1NjfzY-3rvgpx-B}{NW1NjfzY-3rvgpx-D}\nwenddeflinemarkup
, Test.mk "exists_elim_test" (fn () =>
    let
      ...
      val actual = \nwlinkedidentc{Derived.exists_elim}{NW1NjfzY-uZfts-D} x th1 th2;
      fun eq lhs rhs =
...
\nwused{\\{NW1NjfzY-4W6DdR-1}}\nwidentuses{\\{{\nwixident{Assert.that}}{Assert.that}}\\{{\nwixident{Derived.exists{\_}elim}}{Derived.exists:unelim}}\\{{\nwixident{Formula.eq}}{Formula.eq}}\\{{\nwixident{Formula.mk{\_}exists}}{Formula.mk:unexists}}\\{{\nwixident{Formula.mk{\_}pred}}{Formula.mk:unpred}}\\{{\nwixident{Formula.serialize}}{Formula.serialize}}\\{{\nwixident{Sort.IND}}{Sort.IND}}\\{{\nwixident{Test.mk}}{Test.mk}}\\{{\nwixident{Thm.assume}}{Thm.assume}}\\{{\nwixident{Thm.concl}}{Thm.concl}}\\{{\nwixident{Thm.hyps}}{Thm.hyps}}}\nwindexuse{\nwixident{Assert.that}}{Assert.that}{NW1NjfzY-3rvgpx-C}\nwindexuse{\nwixident{Derived.exists{\_}elim}}{Derived.exists:unelim}{NW1NjfzY-3rvgpx-C}\nwindexuse{\nwixident{Formula.eq}}{Formula.eq}{NW1NjfzY-3rvgpx-C}\nwindexuse{\nwixident{Formula.mk{\_}exists}}{Formula.mk:unexists}{NW1NjfzY-3rvgpx-C}\nwindexuse{\nwixident{Formula.mk{\_}pred}}{Formula.mk:unpred}{NW1NjfzY-3rvgpx-C}\nwindexuse{\nwixident{Formula.serialize}}{Formula.serialize}{NW1NjfzY-3rvgpx-C}\nwindexuse{\nwixident{Sort.IND}}{Sort.IND}{NW1NjfzY-3rvgpx-C}\nwindexuse{\nwixident{Test.mk}}{Test.mk}{NW1NjfzY-3rvgpx-C}\nwindexuse{\nwixident{Thm.assume}}{Thm.assume}{NW1NjfzY-3rvgpx-C}\nwindexuse{\nwixident{Thm.concl}}{Thm.concl}{NW1NjfzY-3rvgpx-C}\nwindexuse{\nwixident{Thm.hyps}}{Thm.hyps}{NW1NjfzY-3rvgpx-C}\nwendcode{}\nwbegindocs{139}\nwdocspar
...
\nwindexdefn{\nwixident{Derived.forall{\_}cong}}{Derived.forall:uncong}{NW1NjfzY-uZfts-E}\eatline
\nwused{\\{NW1NjfzY-4dPl0p-1}}\nwidentdefs{\\{{\nwixident{Derived.forall{\_}cong}}{Derived.forall:uncong}}}\nwidentuses{\\{{\nwixident{Formula.mk{\_}forall}}{Formula.mk:unforall}}\\{{\nwixident{Formula.t}}{Formula.t}}\\{{\nwixident{Term.have{\_}same{\_}sort}}{Term.have:unsame:unsort}}\\{{\nwixident{Term.t}}{Term.t}}\\{{\nwixident{Thm.assume}}{Thm.assume}}\\{{\nwixident{Thm.disch}}{Thm.disch}}\\{{\nwixident{Thm.forall{\_}elim}}{Thm.forall:unelim}}\\{{\nwixident{Thm.forall{\_}intro}}{Thm.forall:unintro}}\\{{\nwixident{Thm.t}}{Thm.t}}}\nwindexuse{\nwixident{Formula.mk{\_}forall}}{Formula.mk:unforall}{NW1NjfzY-uZfts-E}\nwindexuse{\nwixident{Formula.t}}{Formula.t}{NW1NjfzY-uZfts-E}\nwindexuse{\nwixident{Term.have{\_}same{\_}sort}}{Term.have:unsame:unsort}{NW1NjfzY-uZfts-E}\nwindexuse{\nwixident{Term.t}}{Term.t}{NW1NjfzY-uZfts-E}\nwindexuse{\nwixident{Thm.assume}}{Thm.assume}{NW1NjfzY-uZfts-E}\nwindexuse{\nwixident{Thm.disch}}{Thm.disch}{NW1NjfzY-uZfts-E}\nwindexuse{\nwixident{Thm.forall{\_}elim}}{Thm.forall:unelim}{NW1NjfzY-uZfts-E}\nwindexuse{\nwixident{Thm.forall{\_}intro}}{Thm.forall:unintro}{NW1NjfzY-uZfts-E}\nwindexuse{\nwixident{Thm.t}}{Thm.t}{NW1NjfzY-uZfts-E}\nwendcode{}\nwbegindocs{141}\nwdocspar
\nwenddocs{}\nwbegincode{142}\sublabel{NW1NjfzY-3rvgpx-D}\nwmargintag{{\nwtagstyle{}\subpageref{NW1NjfzY-3rvgpx-D}}}\moddef{Unit tests for \code{}Derived.sml\edoc{}~{\nwtagstyle{}\subpageref{NW1NjfzY-3rvgpx-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW1NjfzY-4W6DdR-1}}\nwprevnextdefs{NW1NjfzY-3rvgpx-C}{\relax}\nwenddeflinemarkup
, Test.mk "forall_cong_test" (fn () =>
    let
      ...
      val actual = Thm.concl(\nwlinkedidentc{Derived.forall_cong}{NW1NjfzY-uZfts-E} x y A);
    in
      Assert.that (Formula.eq expected actual)
                  (concat ["Expecting: ",
                           (Formula.serialize expected),
...
\nwused{\\{NW1NjfzY-4W6DdR-1}}\nwidentuses{\\{{\nwixident{Assert.that}}{Assert.that}}\\{{\nwixident{Derived.forall{\_}cong}}{Derived.forall:uncong}}\\{{\nwixident{Formula.eq}}{Formula.eq}}\\{{\nwixident{Formula.mk{\_}forall}}{Formula.mk:unforall}}\\{{\nwixident{Formula.mk{\_}imp}}{Formula.mk:unimp}}\\{{\nwixident{Formula.mk{\_}pred}}{Formula.mk:unpred}}\\{{\nwixident{Formula.serialize}}{Formula.serialize}}\\{{\nwixident{Sort.IND}}{Sort.IND}}\\{{\nwixident{Test.mk}}{Test.mk}}\\{{\nwixident{Thm.concl}}{Thm.concl}}}\nwindexuse{\nwixident{Assert.that}}{Assert.that}{NW1NjfzY-3rvgpx-D}\nwindexuse{\nwixident{Derived.forall{\_}cong}}{Derived.forall:uncong}{NW1NjfzY-3rvgpx-D}\nwindexuse{\nwixident{Formula.eq}}{Formula.eq}{NW1NjfzY-3rvgpx-D}\nwindexuse{\nwixident{Formula.mk{\_}forall}}{Formula.mk:unforall}{NW1NjfzY-3rvgpx-D}\nwindexuse{\nwixident{Formula.mk{\_}imp}}{Formula.mk:unimp}{NW1NjfzY-3rvgpx-D}\nwindexuse{\nwixident{Formula.mk{\_}pred}}{Formula.mk:unpred}{NW1NjfzY-3rvgpx-D}\nwindexuse{\nwixident{Formula.serialize}}{Formula.serialize}{NW1NjfzY-3rvgpx-D}\nwindexuse{\nwixident{Sort.IND}}{Sort.IND}{NW1NjfzY-3rvgpx-D}\nwindexuse{\nwixident{Test.mk}}{Test.mk}{NW1NjfzY-3rvgpx-D}\nwindexuse{\nwixident{Thm.concl}}{Thm.concl}{NW1NjfzY-3rvgpx-D}\nwendcode{}\nwbegindocs{143}\nwdocspar
\nwenddocs{}
...
\nwixlogsorted{c}{{Ensure \code{}v\edoc{} is ``free enough'' for \code{}Tactic.exists{\_}elim\edoc{}}{NW1NjfzY-1ErEEN-1}{\nwixu{NW1NjfzY-uZfts-D}\nwixd{NW1NjfzY-1ErEEN-1}}}%
